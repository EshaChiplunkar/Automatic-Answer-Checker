...
';
    ...
    for ($i = 1; $i <= @$_GET['n']; $i++) {
        echo '<b>Question number&nbsp;' . $i . '&nbsp;:</><br /><div class="col-sm-12 form-group text-center">
<label><font color="red">*</font>Model Question :</label>
<textarea name="qns'.$i.'" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_CKEditor1" onkeypress="return CheckLength(this,event,500);">
</textarea>
<br />

<div class="col-sm-12 form-group text-center">
<label><font color="red">*</font>Model Answer :</label>
<textarea name="'.$i.'1" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_ModelAnswerTxt">
</textarea>

<div class="col-sm-12 form-group text-center">
<label><font color="red">*</font>Keywords :</label>
<textarea name="ctl00$ContentPlaceHolder1$KeywordsTxt" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_KeywordsTxt">
</textarea>

<br />
</div>
<div class="col-sm-12 form-group text-center">
<div class="col-sm-20 form-group text-center">
<label><font color="red">*</font>Question Marks :</label>
 <input name="ctl00$ContentPlaceHolder1$SubjectiveMarksTxt" type="text" maxlength="2" id="ctl00_ContentPlaceHolder1_SubjectiveMarksTxt"  />
</input>
</div>
</div>
